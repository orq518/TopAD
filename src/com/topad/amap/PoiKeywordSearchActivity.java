					...
					public void onGetInputtips(List<Tip> tipList, int rCode) {
						if (rCode == 0) {// 正确返回
							...
							for (int i = 0; i < tipList.size(); i++) {
								...
								LogUtil.d("tipList.get(i).getName():" + tipList.get(i).getName());
								LogUtil.d("tipList.get(i).getDistrict():" + tipList.get(i).getDistrict());
								LogUtil.d("tipList.get(i).getAdcode():"+tipList.get(i).getAdcode());
								LogUtil.d("tipList.get(i).toString:"+tipList.get(i).toString());
							}
