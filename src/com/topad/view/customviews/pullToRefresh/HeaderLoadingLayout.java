...
public class HeaderLoadingLayout extends LoadingLayout {
    ...
    private void init(Context context) {
        mHeaderContainer = (RelativeLayout) findViewById(R.id.pull_to_refresh_header);
        ...
        mHeaderTimeView = (TextView) findViewById(R.id.pull_to_refresh_updated_at);
        mHeaderTimeViewTitle = (TextView) findViewById(R.id.pull_to_refresh_updated_at);
...
//        mHeaderTimeView.setText(label);
    ...
    protected View createLoadingView(Context context, AttributeSet attrs) {
        View container = LayoutInflater.from(context).inflate(R.layout.refresh_header, null);
        return container;
    }
