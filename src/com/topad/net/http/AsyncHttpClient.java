...
public class AsyncHttpClient {
    ...
    private static SchemeRegistry getDefaultSchemeRegistry(boolean fixNoHttpResponseException, int httpPort, int httpsPort) {
        if (fixNoHttpResponseException) {
            LogUtil.d(LOG_TAG, "Beware! Using the fix is insecure, as it doesn't verify SSL certificates.");
        }

        if (httpPort < 1) {
            httpPort = 80;
            LogUtil.d(LOG_TAG, "Invalid HTTP port number specified, defaulting to 80");
        }

        if (httpsPort < 1) {
            httpsPort = 443;
            LogUtil.d(LOG_TAG, "Invalid HTTPS port number specified, defaulting to 443");
        }
    ...
    public AsyncHttpClient(SchemeRegistry schemeRegistry) {
        ...
        HttpProtocolParams.setUserAgent(httpParams, String.format("android", VERSION));
    ...
    public void setContentType(String content) {
        final HttpParams httpParams = this.httpClient.getParams();
        httpParams.setParameter("content-type"," text/plain");
    }
    ...
    protected RequestHandle sendRequest(DefaultHttpClient client, HttpContext httpContext, HttpUriRequest uriRequest, String contentType, ResponseHandlerInterface responseHandler, Context context) {
        ...
        LogUtil.d("AsyncHttpClient", "submit to thread pool time is:" + (submit - send));
        ...
        LogUtil.d("AsyncHttpClient", "request handle time is:" + (requestTime - submit));
    ...
    public static void silentCloseInputStream(InputStream is) {
        try {
            ...
            LogUtil.d(LOG_TAG, "Cannot close input stream");
        }
    }
    ...
    public static void silentCloseOutputStream(OutputStream os) {
        try {
            ...
            LogUtil.d(LOG_TAG, "Cannot close output stream");
        }
    }
    ...
    public void fillProxy(final Context context)
    {
    	final HttpParams httpParams = this.httpClient.getParams();
